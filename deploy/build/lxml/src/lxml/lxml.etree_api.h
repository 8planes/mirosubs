...
static PyObject *(*getNsTagWithEmptyNs)(PyObject *);
...
static int import_lxml__etree(void) {
  ...
  if (__Pyx_ImportFunction(module, "getNsTagWithEmptyNs", (void (**)(void))&getNsTagWithEmptyNs, "PyObject *(PyObject *)") < 0) goto bad;
  ...
  __pyx_ptype_4lxml_5etree__Document = __Pyx_ImportType("lxml.etree", "_Document", sizeof(struct LxmlDocument), 1); if (!__pyx_ptype_4lxml_5etree__Document) goto bad;
  __pyx_ptype_4lxml_5etree__Element = __Pyx_ImportType("lxml.etree", "_Element", sizeof(struct LxmlElement), 1); if (!__pyx_ptype_4lxml_5etree__Element) goto bad;
  __pyx_ptype_4lxml_5etree__ElementTree = __Pyx_ImportType("lxml.etree", "_ElementTree", sizeof(struct LxmlElementTree), 1); if (!__pyx_ptype_4lxml_5etree__ElementTree) goto bad;
  __pyx_ptype_4lxml_5etree__ElementTagMatcher = __Pyx_ImportType("lxml.etree", "_ElementTagMatcher", sizeof(struct LxmlElementTagMatcher), 1); if (!__pyx_ptype_4lxml_5etree__ElementTagMatcher) goto bad;
  __pyx_ptype_4lxml_5etree__ElementIterator = __Pyx_ImportType("lxml.etree", "_ElementIterator", sizeof(struct LxmlElementIterator), 1); if (!__pyx_ptype_4lxml_5etree__ElementIterator) goto bad;
  __pyx_ptype_4lxml_5etree_ElementBase = __Pyx_ImportType("lxml.etree", "ElementBase", sizeof(struct LxmlElementBase), 1); if (!__pyx_ptype_4lxml_5etree_ElementBase) goto bad;
  __pyx_ptype_4lxml_5etree_ElementClassLookup = __Pyx_ImportType("lxml.etree", "ElementClassLookup", sizeof(struct LxmlElementClassLookup), 1); if (!__pyx_ptype_4lxml_5etree_ElementClassLookup) goto bad;
  __pyx_ptype_4lxml_5etree_FallbackElementClassLookup = __Pyx_ImportType("lxml.etree", "FallbackElementClassLookup", sizeof(struct LxmlFallbackElementClassLookup), 1); if (!__pyx_ptype_4lxml_5etree_FallbackElementClassLookup) goto bad;
  return 0;
  bad:
  Py_XDECREF(module);
  return -1;
