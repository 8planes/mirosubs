...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'SubtitleFetchCounters', fields ['date', 'video', 'language']
        db.create_unique('statistic_subtitlefetchcounters', ['date', 'video_id', 'language'])

        # Adding unique constraint on 'VideoViewCounter', fields ['date', 'video']
        db.create_unique('statistic_videoviewcounter', ['date', 'video_id'])

        # Adding unique constraint on 'WidgetViewCounter', fields ['date', 'video']
        db.create_unique('statistic_widgetviewcounter', ['date', 'video_id'])
    
    
    def backwards(self, orm):
        
        # Removing unique constraint on 'SubtitleFetchCounters', fields ['date', 'video', 'language']
        db.delete_unique('statistic_subtitlefetchcounters', ['date', 'video_id', 'language'])

        # Removing unique constraint on 'VideoViewCounter', fields ['date', 'video']
        db.delete_unique('statistic_videoviewcounter', ['date', 'video_id'])

        # Removing unique constraint on 'WidgetViewCounter', fields ['date', 'video']
        db.delete_unique('statistic_widgetviewcounter', ['date', 'video_id'])
    ...
    models = {
        ...
        'statistic.subtitlefetchcounters': {
            'Meta': {'unique_together': "(('video', 'language', 'date'),)", 'object_name': 'SubtitleFetchCounters'},
        ...
        'statistic.videoviewcounter': {
            'Meta': {'unique_together': "(('video', 'date'),)", 'object_name': 'VideoViewCounter'},
            'count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'date': ('django.db.models.fields.DateField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'video': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['videos.Video']"})
        },
        'statistic.widgetviewcounter': {
            'Meta': {'unique_together': "(('video', 'date'),)", 'object_name': 'WidgetViewCounter'},
            'count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'date': ('django.db.models.fields.DateField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'video': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['videos.Video']"})
