...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'WidgetViewCounter'
        db.create_table('statistic_widgetviewcounter', (
        ...
        db.send_create_signal('statistic', ['WidgetViewCounter'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'WidgetViewCounter'
        db.delete_table('statistic_widgetviewcounter')
    ...
    models = {
        ...
        'statistic.widgetviewcounter': {
            'Meta': {'object_name': 'WidgetViewCounter'},
            'count': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            'date': ('django.db.models.fields.DateField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'video': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['videos.Video']"})
