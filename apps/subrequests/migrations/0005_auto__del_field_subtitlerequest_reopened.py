...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SubtitleRequest.reopened'
        db.delete_column('subrequests_subtitlerequest', 'reopened')
    
    
    def backwards(self, orm):
        
        # Adding field 'SubtitleRequest.reopened'
        db.add_column('subrequests_subtitlerequest', 'reopened', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
