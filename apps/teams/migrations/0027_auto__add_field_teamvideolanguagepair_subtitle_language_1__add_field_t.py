...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TeamVideoLanguagePair.subtitle_language_1'
        db.add_column('teams_teamvideolanguagepair', 'subtitle_language_1', self.gf('django.db.models.fields.related.ForeignKey')(related_name='team_video_language_pairs_1', null=True, to=orm['videos.SubtitleLanguage']), keep_default=False)

        # Adding field 'TeamVideoLanguagePair.subtitle_language_0'
        db.add_column('teams_teamvideolanguagepair', 'subtitle_language_0', self.gf('django.db.models.fields.related.ForeignKey')(related_name='team_video_language_pairs_0', null=True, to=orm['videos.SubtitleLanguage']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'TeamVideoLanguagePair.subtitle_language_1'
        db.delete_column('teams_teamvideolanguagepair', 'subtitle_language_1_id')

        # Deleting field 'TeamVideoLanguagePair.subtitle_language_0'
        db.delete_column('teams_teamvideolanguagepair', 'subtitle_language_0_id')
