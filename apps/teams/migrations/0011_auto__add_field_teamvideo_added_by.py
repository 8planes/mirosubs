...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TeamVideo.added_by'
        db.add_column('teams_teamvideo', 'added_by', self.gf('django.db.models.fields.related.ForeignKey')(default=10000, to=orm['auth.CustomUser']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'TeamVideo.added_by'
        db.delete_column('teams_teamvideo', 'added_by_id')
