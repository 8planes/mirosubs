...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TeamVideoLanguage.is_lingua_franca'
        db.add_column('teams_teamvideolanguage', 'is_lingua_franca', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'TeamVideoLanguage.is_lingua_franca'
        db.delete_column('teams_teamvideolanguage', 'is_lingua_franca')
