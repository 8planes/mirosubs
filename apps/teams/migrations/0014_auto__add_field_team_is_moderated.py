...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Team.is_moderated'
        db.add_column('teams_team', 'is_moderated', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Team.is_moderated'
        db.delete_column('teams_team', 'is_moderated')
