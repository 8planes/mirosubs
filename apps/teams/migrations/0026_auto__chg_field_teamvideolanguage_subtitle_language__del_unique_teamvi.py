...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TeamVideoLanguage.subtitle_language'
        db.alter_column('teams_teamvideolanguage', 'subtitle_language_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.SubtitleLanguage']))
    
    def backwards(self, orm):
        
        # Changing field 'TeamVideoLanguage.subtitle_language'
        db.alter_column('teams_teamvideolanguage', 'subtitle_language_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.SubtitleLanguage'], null=True, blank=True))    
