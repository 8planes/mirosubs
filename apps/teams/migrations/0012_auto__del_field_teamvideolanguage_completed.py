...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TeamVideoLanguage.completed'
        db.delete_column('teams_teamvideolanguage', 'completed')
        ...
        db.create_table('teams_teamvideo_completed_languages', (
            ...
            ('teamvideo', models.ForeignKey(orm['teams.teamvideo'], null=False)),
    ...
    def backwards(self, orm):
        ...
        # Adding field 'TeamVideoLanguage.completed'
        db.add_column('teams_teamvideolanguage', 'completed', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
