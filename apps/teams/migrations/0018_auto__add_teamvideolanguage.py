...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TeamVideoLanguage'
        db.create_table('teams_teamvideolanguage', (
            ('language', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('team_video', self.gf('django.db.models.fields.related.ForeignKey')(related_name='languages', to=orm['teams.TeamVideo'])),
            ('is_original', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True)),
            ('is_complete', self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True, blank=True)),
            ...
            ('forked', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True, blank=True)),
            ('percent_done', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('teams', ['TeamVideoLanguage'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'TeamVideoLanguage'
        db.delete_table('teams_teamvideolanguage')
