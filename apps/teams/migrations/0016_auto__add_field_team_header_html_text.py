...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Team.header_html_text'
        db.add_column('teams_team', 'header_html_text', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Team.header_html_text'
        db.delete_column('teams_team', 'header_html_text')
