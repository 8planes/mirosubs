...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Team.page_content'
        db.add_column('teams_team', 'page_content', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Team.page_content'
        db.delete_column('teams_team', 'page_content')
