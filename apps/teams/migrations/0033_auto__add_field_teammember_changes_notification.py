...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TeamMember.changes_notification'
        db.add_column('teams_teammember', 'changes_notification', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'TeamMember.changes_notification'
        db.delete_column('teams_teammember', 'changes_notification')
