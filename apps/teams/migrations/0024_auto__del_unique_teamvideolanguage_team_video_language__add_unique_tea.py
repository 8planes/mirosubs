...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'TeamVideoLanguage', fields ['team_video', 'language']
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'TeamVideoLanguage', fields ['team_video', 'language']
    ...
    models = {
        ...
        'teams.teamvideolanguage': {
            'Meta': {'unique_together': "(('team_video', 'language', 'subtitle_language'),)", 'object_name': 'TeamVideoLanguage'},
