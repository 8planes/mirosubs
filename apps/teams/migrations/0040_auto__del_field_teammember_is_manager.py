...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TeamMember.is_manager'
        db.delete_column('teams_teammember', 'is_manager')
    
    
    def backwards(self, orm):
        
        # Adding field 'TeamMember.is_manager'
        db.add_column('teams_teammember', 'is_manager', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
