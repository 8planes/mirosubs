...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TeamVideoLanguagePair.subtitle_language_0'
        db.alter_column('teams_teamvideolanguagepair', 'subtitle_language_0_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.SubtitleLanguage']))
    
    
    def backwards(self, orm):
        
        # Changing field 'TeamVideoLanguagePair.subtitle_language_0'
        db.alter_column('teams_teamvideolanguagepair', 'subtitle_language_0_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['videos.SubtitleLanguage']))
