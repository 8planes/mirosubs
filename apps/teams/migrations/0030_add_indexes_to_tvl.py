...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'TeamVideoLanguage', fields ['language']
        db.create_index('teams_teamvideolanguage', ['language'])

        # Adding index on 'TeamVideoLanguage', fields ['percent_done']
        db.create_index('teams_teamvideolanguage', ['percent_done'])
    
    
    def backwards(self, orm):
        
        # Removing index on 'TeamVideoLanguage', fields ['language']
        db.delete_index('teams_teamvideolanguage', ['language'])

        # Removing index on 'TeamVideoLanguage', fields ['percent_done']
        db.delete_index('teams_teamvideolanguage', ['percent_done'])
