...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TeamMember.role'
        db.add_column('teams_teammember', 'role', self.gf('django.db.models.fields.CharField')(default='memeber', max_length=16), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'TeamMember.role'
        db.delete_column('teams_teammember', 'role')
    ...
    models = {
        ...
        'teams.teammember': {
            ...
            'role': ('django.db.models.fields.CharField', [], {'default': "'memeber'", 'max_length': '16'}),
