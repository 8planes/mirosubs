...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TeamVideo.created'
        db.add_column('teams_teamvideo', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2011, 4, 6), blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'TeamVideo.created'
        db.delete_column('teams_teamvideo', 'created')
