...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TeamVideoLanguagePairs'
        db.create_table('teams_teamvideolanguagepair', (
            ('language_1', self.gf('django.db.models.fields.CharField')(max_length=16, db_index=True)),
            ('language_0', self.gf('django.db.models.fields.CharField')(max_length=16, db_index=True)),
            ...
            ('language_pair', self.gf('django.db.models.fields.CharField')(max_length=16, db_index=True)),
            ('percent_complete', self.gf('django.db.models.fields.IntegerField')(default=0, db_index=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('teams', ['TeamVideoLanguagePair'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'TeamVideoLanguagePairs'
        db.delete_table('teams_teamvideolanguagepair')
