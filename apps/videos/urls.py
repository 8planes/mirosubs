...
urlpatterns = patterns(
    ...
    url(r'^stop_notification/(?P<video_key>(\w|-)+)/$', 'stop_notification', name='stop_notification'),    
    ...
    url(r'^(?P<video_key>(\w|-)+)/$', 'history', name='history'),
    url(r'(?P<video_key>(\w|-)+)/info/$', 'video', name='video'),
    url(r'(?P<video_key>(\w|-)+)/info/(?P<title>[^/]+)/$', 'video', name='video_with_title'),
    url(r'(?P<video_key>(\w|-)+)/url/(?P<video_url>\d+)/$', 'video', name='video_url'),
    url(r'^(?P<video_key>(\w|-)+)/(?P<lang>[\w\-]+)/$', 'history', name='translation_history'),
)
