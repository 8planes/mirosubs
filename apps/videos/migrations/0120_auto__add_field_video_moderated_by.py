...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.moderated_by'
        db.add_column('videos_video', 'moderated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='moderating', null=True, to=orm['teams.Team']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Video.moderated_by'
        db.delete_column('videos_video', 'moderated_by_id')
