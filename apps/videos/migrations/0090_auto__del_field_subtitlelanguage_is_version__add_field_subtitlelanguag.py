...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubtitleLanguage.is_complete'
        db.add_column('videos_subtitlelanguage', 'is_complete', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'SubtitleLanguage.is_complete'
        db.delete_column('videos_subtitlelanguage', 'is_complete')
