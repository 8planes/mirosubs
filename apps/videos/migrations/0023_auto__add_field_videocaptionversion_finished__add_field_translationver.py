...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VideoCaptionVersion.finished'
        db.add_column('videos_videocaptionversion', 'finished', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'TranslationVersion.finished'
        db.add_column('videos_translationversion', 'finished', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        if not db.dry_run:
            orm.VideoCaptionVersion.objects.update(finished=True)

        if not db.dry_run:
            orm.TranslationVersion.objects.update(finished=True)

        # Changing field 'Video.video_url'
        db.alter_column('videos_video', 'video_url', self.gf('django.db.models.fields.URLField')(max_length=2048, blank=True))

        # Changing field 'Video.bliptv_fileid'
        db.alter_column('videos_video', 'bliptv_fileid', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True))

        # Changing field 'Video.bliptv_flv_url'
        db.alter_column('videos_video', 'bliptv_flv_url', self.gf('django.db.models.fields.CharField')(max_length=256, blank=True))

        # Changing field 'Video.youtube_videoid'
        db.alter_column('videos_video', 'youtube_videoid', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'VideoCaptionVersion.finished'
        db.delete_column('videos_videocaptionversion', 'finished')

        # Deleting field 'TranslationVersion.finished'
        db.delete_column('videos_translationversion', 'finished')

        # Changing field 'Video.video_url'
        db.alter_column('videos_video', 'video_url', self.gf('django.db.models.fields.URLField')(max_length=2048))

        # Changing field 'Video.bliptv_fileid'
        db.alter_column('videos_video', 'bliptv_fileid', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Video.bliptv_flv_url'
        db.alter_column('videos_video', 'bliptv_flv_url', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Video.youtube_videoid'
        db.alter_column('videos_video', 'youtube_videoid', self.gf('django.db.models.fields.CharField')(max_length=32))
