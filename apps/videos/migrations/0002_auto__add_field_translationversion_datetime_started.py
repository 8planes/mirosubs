...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('videos_translationversion', 'datetime_started', self.gf('django.db.models.fields.DateTimeField')(default=datetime.date(2010, 4, 15)), keep_default=False)
