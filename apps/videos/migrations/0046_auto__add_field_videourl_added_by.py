...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VideoUrl.added_by'
        db.add_column('videos_videourl', 'added_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.CustomUser'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'VideoUrl.added_by'
        db.delete_column('videos_videourl', 'added_by_id')
