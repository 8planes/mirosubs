...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubtitleDraft.moderation_status'
        db.add_column('videos_subtitledraft', 'moderation_status', self.gf('django.db.models.fields.CharField')(default='not__under_moderation', max_length=32, db_index=True), keep_default=False)
        
        # Adding field 'SubtitleVersion.moderation_status'
        db.add_column('videos_subtitleversion', 'moderation_status', self.gf('django.db.models.fields.CharField')(default='not__under_moderation', max_length=32, db_index=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubtitleVersion.moderation_status'
        db.delete_column('videos_subtitleversion', 'moderation_status')
    ...
    models = {
        ...
        'videos.subtitleversion': {
            ...
            'is_forked': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'language': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['videos.SubtitleLanguage']"}),
            'moderation_status': ('django.db.models.fields.CharField', [], {'default': "'not__under_moderation'", 'max_length': '16'}),
