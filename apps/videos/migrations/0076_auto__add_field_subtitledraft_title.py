...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubtitleDraft.title'
        db.add_column('videos_subtitledraft', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=2048, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubtitleDraft.title'
        db.delete_column('videos_subtitledraft', 'title')
