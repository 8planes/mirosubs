...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VideoCaptionVersion.note'
        db.add_column('videos_videocaptionversion', 'note', self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True), keep_default=False)

        # Adding field 'VideoCaptionVersion.time_change'
        db.add_column('videos_videocaptionversion', 'time_change', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'VideoCaptionVersion.text_change'
        db.add_column('videos_videocaptionversion', 'text_change', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'TranslationVersion.note'
        db.add_column('videos_translationversion', 'note', self.gf('django.db.models.fields.CharField')(default='', max_length=512, blank=True), keep_default=False)

        # Adding field 'TranslationVersion.time_change'
        db.add_column('videos_translationversion', 'time_change', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'TranslationVersion.text_change'
        db.add_column('videos_translationversion', 'text_change', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'VideoCaptionVersion.note'
        db.delete_column('videos_videocaptionversion', 'note')

        # Deleting field 'VideoCaptionVersion.time_change'
        db.delete_column('videos_videocaptionversion', 'time_change')

        # Deleting field 'VideoCaptionVersion.text_change'
        db.delete_column('videos_videocaptionversion', 'text_change')

        # Deleting field 'TranslationVersion.note'
        db.delete_column('videos_translationversion', 'note')

        # Deleting field 'TranslationVersion.time_change'
        db.delete_column('videos_translationversion', 'time_change')

        # Deleting field 'TranslationVersion.text_change'
        db.delete_column('videos_translationversion', 'text_change')
