...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'VideoCaptionVersion.is_complete'
        db.delete_column('videos_videocaptionversion', 'is_complete')

        # Deleting field 'TranslationVersion.is_complete'
        db.delete_column('videos_translationversion', 'is_complete')

        # Deleting field 'NullVideoCaptions.is_complete'
        db.delete_column('videos_nullvideocaptions', 'is_complete')

        # Deleting field 'NullTranslations.is_complete'
        db.delete_column('videos_nulltranslations', 'is_complete')
    
    
    def backwards(self, orm):
        
        # Adding field 'VideoCaptionVersion.is_complete'
        db.add_column('videos_videocaptionversion', 'is_complete', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'TranslationVersion.is_complete'
        db.add_column('videos_translationversion', 'is_complete', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'NullVideoCaptions.is_complete'
        db.add_column('videos_nullvideocaptions', 'is_complete', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'NullTranslations.is_complete'
        db.add_column('videos_nulltranslations', 'is_complete', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
