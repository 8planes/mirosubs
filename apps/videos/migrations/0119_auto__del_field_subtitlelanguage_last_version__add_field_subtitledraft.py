...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SubtitleLanguage.last_version'
        db.delete_column('videos_subtitlelanguage', 'last_version_id')

    
    
    def backwards(self, orm):
        
        # Adding field 'SubtitleLanguage.last_version'
        db.add_column('videos_subtitlelanguage', 'last_version', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.SubtitleVersion'], null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'videos.subtitleversion': {
            ...
            'is_forked': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'blank': 'True'}),
            'language': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['videos.SubtitleLanguage']"}),
            'moderation_status': ('django.db.models.fields.CharField', [], {'default': "'not__under_moderation'", 'max_length': '32'}),
