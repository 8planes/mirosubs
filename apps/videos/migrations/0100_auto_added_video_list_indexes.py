...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Video', fields ['view_count']
        db.create_index('videos_video', ['view_count'])

        # Adding index on 'Video', fields ['subtitles_fetched_count']
        db.create_index('videos_video', ['subtitles_fetched_count'])

        # Adding index on 'Video', fields ['widget_views_count']
        db.create_index('videos_video', ['widget_views_count'])
    
    
    def backwards(self, orm):
        
        # Removing index on 'Video', fields ['view_count']
        db.delete_index('videos_video', ['view_count'])

        # Removing index on 'Video', fields ['subtitles_fetched_count']
        db.delete_index('videos_video', ['subtitles_fetched_count'])

        # Removing index on 'Video', fields ['widget_views_count']
        db.delete_index('videos_video', ['widget_views_count'])
