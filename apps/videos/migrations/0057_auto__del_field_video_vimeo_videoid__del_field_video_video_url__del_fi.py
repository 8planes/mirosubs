...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Video.vimeo_videoid'
        db.delete_column('videos_video', 'vimeo_videoid')

        # Deleting field 'Video.video_url'
        db.delete_column('videos_video', 'video_url')

        # Deleting field 'Video.video_type'
        db.delete_column('videos_video', 'video_type')

        # Deleting field 'Video.bliptv_flv_url'
        db.delete_column('videos_video', 'bliptv_flv_url')

        # Deleting field 'Video.dailymotion_videoid'
        db.delete_column('videos_video', 'dailymotion_videoid')

        # Deleting field 'Video.bliptv_fileid'
        db.delete_column('videos_video', 'bliptv_fileid')

        # Deleting field 'Video.youtube_videoid'
        db.delete_column('videos_video', 'youtube_videoid')
    
    
    def backwards(self, orm):
        
        # Adding field 'Video.vimeo_videoid'
        db.add_column('videos_video', 'vimeo_videoid', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True), keep_default=False)

        # Adding field 'Video.video_url'
        db.add_column('videos_video', 'video_url', self.gf('django.db.models.fields.URLField')(default='', max_length=2048, blank=True), keep_default=False)

        # Adding field 'Video.video_type'
        db.add_column('videos_video', 'video_type', self.gf('django.db.models.fields.CharField')(default='', max_length=1), keep_default=False)

        # Adding field 'Video.bliptv_flv_url'
        db.add_column('videos_video', 'bliptv_flv_url', self.gf('django.db.models.fields.CharField')(default='', max_length=256, blank=True), keep_default=False)

        # Adding field 'Video.dailymotion_videoid'
        db.add_column('videos_video', 'dailymotion_videoid', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True), keep_default=False)

        # Adding field 'Video.bliptv_fileid'
        db.add_column('videos_video', 'bliptv_fileid', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True), keep_default=False)

        # Adding field 'Video.youtube_videoid'
        db.add_column('videos_video', 'youtube_videoid', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True), keep_default=False)
