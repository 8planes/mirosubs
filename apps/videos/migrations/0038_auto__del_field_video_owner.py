...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Video.owner'
        db.delete_column('videos_video', 'owner_id')
    
    
    def backwards(self, orm):
        
        # Adding field 'Video.owner'
        db.add_column('videos_video', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.CustomUser'], null=True), keep_default=False)
