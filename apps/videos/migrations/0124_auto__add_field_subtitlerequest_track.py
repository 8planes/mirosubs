...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubtitleRequest.track'
        db.add_column('videos_subtitlerequest', 'track', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubtitleRequest.track'
        db.delete_column('videos_subtitlerequest', 'track')
