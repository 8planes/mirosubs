...
thumb_url_pattern = 'http://i.ytimg.com/vi/%s/default.jpg'

class Migration(DataMigration):
    
    def forwards(self, orm):
        qs = orm.VideoUrl.objects.filter(type=VIDEO_TYPE_YOUTUBE).select_related('video')
        count = qs.count()
        ...
        for vu in qs:
            ...
            video.small_thumbnail = thumb_url_pattern % vu.videoid
            video.save()
