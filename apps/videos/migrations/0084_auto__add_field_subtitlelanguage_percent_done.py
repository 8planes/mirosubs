...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubtitleLanguage.percent_done'
        db.add_column('videos_subtitlelanguage', 'percent_done', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubtitleLanguage.percent_done'
        db.delete_column('videos_subtitlelanguage', 'percent_done')
