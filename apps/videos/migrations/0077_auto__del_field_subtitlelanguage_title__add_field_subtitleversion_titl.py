...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'SubtitleLanguage.title'
        db.delete_column('videos_subtitlelanguage', 'title')

        # Adding field 'SubtitleVersion.title'
        db.add_column('videos_subtitleversion', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=2048, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Adding field 'SubtitleLanguage.title'
        db.add_column('videos_subtitlelanguage', 'title', self.gf('django.db.models.fields.CharField')(default='', max_length=2048, blank=True), keep_default=False)

        # Deleting field 'SubtitleVersion.title'
        db.delete_column('videos_subtitleversion', 'title')
