...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubtitleRequest.user'
        db.add_column('videos_subtitlerequest', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='subreqs', to=orm['auth.CustomUser']), keep_default=False)

        # Removing M2M table for field users on 'SubtitleRequest'
        db.delete_table('videos_subtitlerequest_users')
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubtitleRequest.user'
        db.delete_column('videos_subtitlerequest', 'user_id')

        # Adding M2M table for field users on 'SubtitleRequest'
        db.create_table('videos_subtitlerequest_users', (
        ...
        db.create_unique('videos_subtitlerequest_users', ['subtitlerequest_id', 'customuser_id'])
    ...
    models = {
        ...
        'videos.subtitlerequest': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'subreqs'", 'to': "orm['auth.CustomUser']"}),
            'video': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['videos.Video']"})
        },
