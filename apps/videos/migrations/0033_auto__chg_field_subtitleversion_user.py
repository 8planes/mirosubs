...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubtitleVersion.user'
        db.alter_column('videos_subtitleversion', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.CustomUser'], null=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'SubtitleVersion.user'
        db.alter_column('videos_subtitleversion', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.CustomUser']))
