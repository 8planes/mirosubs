...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        try:
            ...
            raise Exception('This is complex data migration. So if you run this on local version or empty database - you can fake it with: python manage.py migrate videos 0085 --fake')
