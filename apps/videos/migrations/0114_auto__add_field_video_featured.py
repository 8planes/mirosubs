...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('videos_video', 'featured', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Video.featured'
        db.delete_column('videos_video', 'featured')
