...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Video', fields ['was_subtitled']
        db.create_index('videos_video', ['was_subtitled'])
    
    
    def backwards(self, orm):
        
        # Removing index on 'Video', fields ['was_subtitled']
        db.delete_index('videos_video', ['was_subtitled'])
