...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Action.new_video_title'
        db.add_column('videos_action', 'new_video_title', self.gf('django.db.models.fields.CharField')(default='', max_length=2048, blank=True), keep_default=False)    
    
    def backwards(self, orm):
        
        # Deleting field 'Action.new_video_title'
        db.delete_column('videos_action', 'new_video_title')
