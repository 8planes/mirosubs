...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('videos_video', 'youtube_name', 'title')

        # Adding field 'Video.bliptv_fileid'
        db.add_column('videos_video', 'bliptv_fileid', self.gf('django.db.models.fields.CharField')(default='', max_length=32), keep_default=False)

        # Adding field 'Video.bliptv_flv_url'
        db.add_column('videos_video', 'bliptv_flv_url', self.gf('django.db.models.fields.CharField')(default='', max_length=256), keep_default=False)

    def backwards(self, orm):
        db.rename_column('videos_video', 'title', 'youtube_name')
