...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Subtitle', fields ['draft', 'subtitle_id']
        db.create_unique('videos_subtitle', ['draft_id', 'subtitle_id'])
    
    
    def backwards(self, orm):
        
        # Removing unique constraint on 'Subtitle', fields ['draft', 'subtitle_id']
        db.delete_unique('videos_subtitle', ['draft_id', 'subtitle_id'])
