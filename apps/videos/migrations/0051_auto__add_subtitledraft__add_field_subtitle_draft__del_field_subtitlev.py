...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SubtitleDraft'
        db.create_table('videos_subtitledraft', (
            ('last_saved_packet', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ...
            ('is_forked', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
        ...
        db.send_create_signal('videos', ['SubtitleDraft'])

        # Adding field 'Subtitle.draft'
        db.add_column('videos_subtitle', 'draft', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.SubtitleDraft'], null=True), keep_default=False)

        # Deleting field 'SubtitleVersion.last_saved_packet'
        db.delete_column('videos_subtitleversion', 'last_saved_packet')

        # Deleting field 'SubtitleVersion.finished'
        db.delete_column('videos_subtitleversion', 'finished')
    
    
    def backwards(self, orm):
        
        # Deleting model 'SubtitleDraft'
        db.delete_table('videos_subtitledraft')

        # Deleting field 'Subtitle.draft'
        db.delete_column('videos_subtitle', 'draft_id')

        # Adding field 'SubtitleVersion.last_saved_packet'
        db.add_column('videos_subtitleversion', 'last_saved_packet', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)

        # Adding field 'SubtitleVersion.finished'
        db.add_column('videos_subtitleversion', 'finished', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    ...
    models = {
        ...
        'videos.nullsubtitlesplaceholder': {
            'Meta': {'unique_together': "(('video', 'video_session'),)", 'object_name': 'NullSubtitlesPlaceholder'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'original_language': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '16', 'blank': 'True'}),
            'video': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['videos.Video']"}),
            'video_session': ('django.db.models.fields.CharField', [], {'max_length': '128'})
        },
