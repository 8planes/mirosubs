...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubtitleLanguage.created'
        db.add_column('videos_subtitlelanguage', 'created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2010, 11, 15, 11, 40, 56, 979000), blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubtitleLanguage.created'
        db.delete_column('videos_subtitlelanguage', 'created')
