...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('videos_translationlanguage', 'is_complete', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('videos_translationlanguage', 'is_complete')
