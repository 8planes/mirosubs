...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubtitleRequest.done'
        db.add_column('videos_subtitlerequest', 'done', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)

        # Adding field 'SubtitleRequest.time'
        db.add_column('videos_subtitlerequest', 'time', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2011, 7, 11, 7, 15, 41, 147645), blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubtitleRequest.done'
        db.delete_column('videos_subtitlerequest', 'done')

        # Deleting field 'SubtitleRequest.time'
        db.delete_column('videos_subtitlerequest', 'time')
