...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('videos_subtitlerequest', 'time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 7, 19, 9, 17, 14, 836653)), keep_default=False)
