...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'SubtitleLanguage', fields ['video', 'language']
        db.delete_unique('videos_subtitlelanguage', ['video_id', 'language'])

        # Adding unique constraint on 'SubtitleLanguage', fields ['video', 'standard_language', 'language']
        db.create_unique('videos_subtitlelanguage', ['video_id', 'standard_language_id', 'language'])
    
    
    def backwards(self, orm):
        
        # Adding unique constraint on 'SubtitleLanguage', fields ['video', 'language']
        db.create_unique('videos_subtitlelanguage', ['video_id', 'language'])

        # Removing unique constraint on 'SubtitleLanguage', fields ['video', 'standard_language', 'language']
        db.delete_unique('videos_subtitlelanguage', ['video_id', 'standard_language_id', 'language'])
