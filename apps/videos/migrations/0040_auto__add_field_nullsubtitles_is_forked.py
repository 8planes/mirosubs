...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NullSubtitles.is_forked'
        db.add_column('videos_nullsubtitles', 'is_forked', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'NullSubtitles.is_forked'
        db.delete_column('videos_nullsubtitles', 'is_forked')
