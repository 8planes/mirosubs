...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubtitleLanguage.is_version'
        db.add_column('videos_subtitlelanguage', 'is_version', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubtitleLanguage.is_version'
        db.delete_column('videos_subtitlelanguage', 'is_version')
