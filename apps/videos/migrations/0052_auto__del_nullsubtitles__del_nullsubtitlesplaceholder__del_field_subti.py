...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'NullSubtitlesPlaceholder'
        db.delete_table('videos_nullsubtitlesplaceholder')

        # Deleting field 'Subtitle.null_subtitles'
        db.delete_column('videos_subtitle', 'null_subtitles_id')
    ...
    def backwards(self, orm):
        ...
        # Adding model 'NullSubtitlesPlaceholder'
        db.create_table('videos_nullsubtitlesplaceholder', (
            ('original_language', self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True)),
            ('video', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.Video'])),
            ('video_session', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('videos', ['NullSubtitlesPlaceholder'])

        # Adding field 'Subtitle.null_subtitles'
        db.add_column('videos_subtitle', 'null_subtitles', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.NullSubtitles'], null=True), keep_default=False)
