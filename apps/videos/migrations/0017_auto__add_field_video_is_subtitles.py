...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.is_subtitles'
        db.add_column('videos_video', 'is_subtitles', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
        if not db.dry_run:
            for obj in orm.Video.objects.all():
                if obj.videocaptionversion_set.filter(is_complete=True).exists():
                    obj.is_subtitles = True
                    obj.save()
    
    def backwards(self, orm):
        
        # Deleting field 'Video.is_subtitles'
        db.delete_column('videos_video', 'is_subtitles')
    ...
    models = {
        ...
        'videos.video': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_subtitles': ('django.db.models.fields.BooleanField', [], {'default': 'True', 'blank': 'True'}),
