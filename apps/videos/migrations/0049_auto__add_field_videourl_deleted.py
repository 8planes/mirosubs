...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VideoUrl.deleted'
        db.add_column('videos_videourl', 'deleted', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'VideoUrl.deleted'
        db.delete_column('videos_videourl', 'deleted')
