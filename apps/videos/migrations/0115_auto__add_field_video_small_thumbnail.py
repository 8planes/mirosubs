...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.small_thumbnail'
        db.add_column('videos_video', 'small_thumbnail', self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Video.small_thumbnail'
        db.delete_column('videos_video', 'small_thumbnail')
