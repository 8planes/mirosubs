...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProxyVideo'
        db.create_table('videos_proxyvideo', (
            ('video_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['videos.Video'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('videos', ['ProxyVideo'])
    
    
    def backwards(self, orm):
        
        # Deleting model 'ProxyVideo'
        db.delete_table('videos_proxyvideo')
