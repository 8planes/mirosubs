...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('videos_subtitlerequest', 'action', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='subtitlerequests', null=True, to=orm['videos.Action']), keep_default=False)
    ...
    models = {
        ...
        'videos.subtitlerequest': {
            'Meta': {'unique_together': "(('video', 'user', 'time'),)", 'object_name': 'SubtitleRequest'},
            'action': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'subtitlerequests'", 'null': 'True', 'to': "orm['videos.Action']"}),
