...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.complete_date'
        db.add_column('videos_video', 'complete_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Video.complete_date'
        db.delete_column('videos_video', 'complete_date')
