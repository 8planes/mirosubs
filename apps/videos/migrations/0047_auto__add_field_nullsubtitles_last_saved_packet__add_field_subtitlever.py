...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NullSubtitles.last_saved_packet'
        db.add_column('videos_nullsubtitles', 'last_saved_packet', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'NullSubtitles.last_saved_packet'
        db.delete_column('videos_nullsubtitles', 'last_saved_packet')
