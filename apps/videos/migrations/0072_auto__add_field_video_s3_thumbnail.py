...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.s3_thumbnail'
        db.add_column('videos_video', 's3_thumbnail', self.gf('utils.amazon.fields.S3EnabledImageField')(default='', max_length=100, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Video.s3_thumbnail'
        db.delete_column('videos_video', 's3_thumbnail')
