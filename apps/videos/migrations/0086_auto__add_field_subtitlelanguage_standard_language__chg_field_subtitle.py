...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SubtitleLanguage.standard_language'
        db.add_column('videos_subtitlelanguage', 'standard_language', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['videos.SubtitleLanguage'], null=True, blank=True), keep_default=False)

        # Changing field 'SubtitleLanguage.writelock_owner'
        db.alter_column('videos_subtitlelanguage', 'writelock_owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.CustomUser'], null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'SubtitleLanguage.standard_language'
        db.delete_column('videos_subtitlelanguage', 'standard_language_id')

        # Changing field 'SubtitleLanguage.writelock_owner'
        db.alter_column('videos_subtitlelanguage', 'writelock_owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.CustomUser'], null=True))
