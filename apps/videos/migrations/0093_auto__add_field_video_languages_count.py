...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.languages_count'
        db.add_column('videos_video', 'languages_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Video.languages_count'
        db.delete_column('videos_video', 'languages_count')
