...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomUser.autoplay_preferences'
        db.add_column('auth_customuser', 'autoplay_preferences', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'CustomUser.autoplay_preferences'
        db.delete_column('auth_customuser', 'autoplay_preferences')
