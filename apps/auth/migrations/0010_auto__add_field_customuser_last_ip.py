...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomUser.last_ip'
        db.add_column('auth_customuser', 'last_ip', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'CustomUser.last_ip'
        db.delete_column('auth_customuser', 'last_ip')
