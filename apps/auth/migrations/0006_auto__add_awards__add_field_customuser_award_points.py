...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CustomUser.award_points'
        db.add_column('auth_customuser', 'award_points', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'CustomUser.award_points'
        db.delete_column('auth_customuser', 'award_points')
