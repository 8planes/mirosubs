...
mirosubs.HowToVideoPanel = function(videoChoice) {
    ...
    if (mirosubs.video.supportsOgg())
        this.videoPlayer_ = 
            mirosubs.video.Html5VideoSource.create(
                videoChoice.videos.ogg, mirosubs.video.Html5VideoType.OGG).createPlayer();
    else if (mirosubs.video.supportsH264())
        this.videoPlayer_ = mirosubs.video.Html5VideoSource.create(
            videoChoice.videos.h264, mirosubs.video.Html5VideoType.H264).createPlayer();
    else
